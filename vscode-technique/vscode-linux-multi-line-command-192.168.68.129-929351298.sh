...
QUALITY="stable"
TOKEN="63220667-1de7-428a-901b-c4ff3b944bdc"
...
# Marker strings
GET_DOWNLOAD_SERVER_START_TRIGGER="0578f43a79be:trigger_server_download"
GET_DOWNLOAD_SERVER_END_TRIGGER="0578f43a79be:trigger_server_download_end"
GET_PROGRESS_DOWNLOADING="0578f43a79be%%1%%"
GET_PROGRESS_INSTALLING="0578f43a79be%%2%%"
